...
The time window available for restore (also known as retention period) is the lower value of the following three options: 7-day, 30-day, and 35-day.
...
Azure Cosmos DB accounts with continuous 30-day or 35-day backup have an extra monthly charge to *store the backup*. All tiers (7, 30, or 35 days) of continuous backup incur charges to *restore your data*. The restore cost is added every time the restore operation is initiated. If you configure an account with continuous backup but don't restore the data, only backup storage cost is included in your bill.
...
* Accounts enabled with continuous backup policy at the 30-day or 35-day tier incur a monthly charge for backup storage. The 30-day and 35-day tiers are charged at the same rate, calculated as follows:
...
* The retention period is 7 days, 30 days, or 35 days, depending on the tier you choose.
* The 30-day and 35-day tiers are charged for backup storage. The 7-day tier isn't charged for backup storage.
...
* The restore window is 7 days for the continuous 7-day tier, 30 days for the continuous 30-day tier, and 35 days for the continuous 35-day tier. You can switch between these tiers, but you can't change the actual quantities (`7`, `30`, or `35`). If you switch to a shorter window, such as from the 30-day or 35-day tier to the 7-day tier, you might lose data on days beyond the new, shorter retention window.
